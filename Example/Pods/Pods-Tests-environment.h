...
// MVReport
#define COCOAPODS_POD_AVAILABLE_MVReport
#define COCOAPODS_VERSION_MAJOR_MVReport 0
#define COCOAPODS_VERSION_MINOR_MVReport 1
#define COCOAPODS_VERSION_PATCH_MVReport 3
